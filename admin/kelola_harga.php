    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>
                        <a href='update_harga.php?id=" . $row['id'] . "' class='action-button'>Update</a>
                        <a href='delete_harga.php?id=" . $row['id'] . "' class='delete-button'>Delete</a>
                    </td>";
...
<a href="input_harga.php"><button class="insert-button">Insert</button></a>
</div>   
